<html>
    ...
    <body>
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <ul class=" nav nav-pills nav-stacked">
                        ...
                        <li><a href="#Interestelar2">Black Hole</li>
                        <li><a href="#Interestelar3">Astronauta</li>
                        <li><a href="#Interestelar4">TONS 618</li>
                        <li><a href="#Interestelar5">Narve en Orbita</li>
                        <li><a href="#Interestelar6">Galaxia</li>
                        <li><a href="#Interestelar7">Pulsar</li>
                    </ul>
                </div>
        ...
        <div class="col-md-4">
                    <div class="well well-lg">
                        <img src="imagenes/Astronauta.jpeg" width="100%">
                        <div class="card-body">
                            <h5>Astronauta</h5>
                            <p>Semilla<p>
        ...
        <div class="col-md-4">
                    <div class="well well-lg">
                        <img src="imagenes/descarga (1).jpeg" width="100%">
                        <div class="card-body">
                            <h5>Galaxia</h5>
                            <p>Semilla<p>
